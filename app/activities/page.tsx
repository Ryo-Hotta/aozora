...
const steps = [
  {
    ...
    step: "Step 1",
    title: "2進数で自分を表現する",
    body: "256名（＝1バイト）それぞれが「0か1」の状態を持つ人間ビットになります。手の上げ下げ・前後の動きなど、自分自身を信号に変換する感覚を身体で覚えます。",
    learning: "情報の最小単位（ビット）と、信号の伝達。",
  },
  {
    icon: Cpu,
    step: "Step 2",
    title: "256人で人間二進数計算機（1バイト＝8ビット加算器）を組み立てる",
    body: "全員でAND/OR/XORの論理ゲートを担当し、屋外で1バイト（8ビット）の二進数加算を実演します。Carry伝播を体で覚えながら、一人ひとりが正しく動かないと計算結果が崩れる構造を体験。★ギネス世界記録 公式挑戦の本番演目。",
    learning: "論理ゲートの組み合わせで計算が成立する仕組み。1バイト＝1単位という情報処理の最小単位。",
  },
  {
    icon: AlertTriangle,
    step: "Step 3",
  ...
  },
  {
    ...
    body: "崩壊を防ぐためのチェック機構を、参加者自身が設計します。トップダウンの指示ではなく、現場の256人が自律的にエラーを直す手順を実装します。",
  ...
  },
  {
    ...
    step: "Final",
    title: "ギネス世界記録 公式挑戦",
    body: "「256人による人間二進数計算機（1バイト演算）」として、ギネス世界記録への公式申請を行います。Step2で組んだ8ビット加算器を本番として認定員立会いのもと実演。挑戦の成立は、全員の正確な動きにかかっています。",
      ...
      <section className="bg-gradient-to-b from-sky-50 to-white border-b border-slate-200">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <p className="mt-5 text-lg text-slate-700 max-w-2xl">
            256人（＝1バイト）で「秩序の生成」を体験する5ステップ＋ギネス公式挑戦。
          </p>
        </div>
      </section>
